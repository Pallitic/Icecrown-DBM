...
local ttsCircle = mod:NewSoundFile("Interface\\AddOns\\DBM-Core\\sounds\\os\\fissure.mp3", "TTS Fissure cast", true)
local ttsNew = mod:NewSoundFile("Interface\\AddOns\\DBM-Core\\sounds\\os\\new.mp3", "TTS New drake coming", true)
local ttsWall = mod:NewSoundFile("Interface\\AddOns\\DBM-Core\\sounds\\os\\wall.mp3", "TTS Fire wall", true)
local ttsPortal = mod:NewSoundFile("Interface\\AddOns\\DBM-Core\\sounds\\os\\port.mp3", "TTS New portal", true)
local ttsWhelps = mod:NewSoundFile("Interface\\AddOns\\DBM-Core\\sounds\\os\\whelp.mp3", "TTS Whelps coming", true)
...
function mod:CheckDrakes(delay)
	...
	if isunitdebuffed(61248) then	-- Power of Tenebron
		...
		ttsNew:Schedule(26 - delay)
		ttsWhelps:Schedule(55 - delay)
