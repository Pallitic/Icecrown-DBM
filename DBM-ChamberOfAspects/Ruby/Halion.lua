...
local ttsCutterIn5 = mod:NewSoundFile("Interface\\AddOns\\DBM-Core\\sounds\\cuttercd.mp3", "TTS Cutter countdown", true)
local ttsCutterIn5Offset = 6.5
local ttsMeteorIn5 = mod:NewSoundFile("Interface\\AddOns\\DBM-Core\\sounds\\meteorcd.mp3", "TTS Meteor countdown", true)
local ttsMeteorIn5Offset = 7
local ttsSlow = mod:NewSoundFile("Interface\\AddOns\\DBM-Core\\sounds\\slowdps.mp3", "TTS Slow dps", true)
local ttsStop = mod:NewSoundFile("Interface\\AddOns\\DBM-Core\\sounds\\stopdps.mp3", "TTS Stop dps", true)
