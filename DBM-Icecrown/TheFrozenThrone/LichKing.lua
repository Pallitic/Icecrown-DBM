...
local ttsInfest = mod:NewSoundFile("Interface\\Addons\\DBM-Core\\sounds\\icc\\lk\\infest.mp3", "TTS infest cast", mod:IsHealer())
local ttsNearST = mod:NewSoundFile("Interface\\AddOns\\DBM-Core\\sounds\\icc\\lk\\shadowtrap.mp3", "TTS Near shadowtrap", true)
local ttsShamb =  mod:NewSoundFile("Interface\\AddOns\\DBM-Core\\sounds\\icc\\lk\\StopCleave.wav", "TTS Stop cleave", true)
local ttsEnrageCast =  mod:NewSoundFile("Interface\\AddOns\\DBM-Core\\sounds\\icc\\lk\\EnrageCast.wav", "TTS Enrage cast", mod:CanRemoveEnrage())
local ttsNecro= mod:NewSoundFile("interface\\AddOns\\DBM-Core\\sounds\\icc\\lk\\necro.wav", "TTS Necrotic on you", true)
local ttsNecrotic = mod:NewSoundFile("Interface\\AddOns\\DBM-Core\\sounds\\icc\\lk\\NecroticPlague_Soon.wav", "TTS Necrotic Soon", false)
local ttsValk = mod:NewSoundFile("Interface\\AddOns\\DBM-Core\\sounds\\icc\\lk\\SummonValkyrs_Soon.wav", "TTS Valk grabs Soon", true)
local ttsDefileCountdown = mod:NewSoundFile("Interface\\AddOns\\DBM-Core\\sounds\\icc\\lk\\Defile_Soon.wav", "TTS Defile Soon", true)
local ttsDefileOnYou = mod:NewSoundFile("Interface\\AddOns\\DBM-Core\\sounds\\icc\\lk\\RunOut.wav", "TTS Defile on you", true)
local ttsReaper = mod:NewSoundFile("Interface\\Addons\\DBM-Core\\sounds\\icc\\lk\\soulreaper.mp3", "TTS Reaper cast", mod:IsTank() or mod:IsHealer())
local ttsSoulreaperSoon = mod:NewSoundFile("Interface\\AddOns\\DBM-Core\\sounds\\icc\\lk\\SoulReaper_soon.wav", "TTS Soulreaper Soon", mod:IsTank() or mod:IsHealer())
local ttsChamber = mod:NewSoundFile("Interface\\AddOns\\DBM-Core\\sounds\\icc\\lk\\HarvestSoul_Soon.wav", "TTS Harvest soul Soon", true)
local ttsFollow = mod:NewSoundFile("Interface\\Addons\\DBM-Core\\sounds\\icc\\lk\\FollowMark.wav", "TTS Follow mark chamber", true)
