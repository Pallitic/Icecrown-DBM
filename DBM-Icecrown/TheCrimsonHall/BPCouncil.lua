...
local ttsTargetSwitch = mod:NewSoundFile("Interface\\AddOns\\DBM-Core\\sounds\\targetswitchcd.mp3", "TTS Target switch Countdown", true)
local ttsVortexNear = mod:NewSoundFile("Interface\\AddOns\\DBM-Core\\sounds\\vortexNear.mp3", "TTS Near Vortex call", true)
local ttsFireOrb = mod:NewSoundFile("Interface\\AddOns\\DBM-Core\\sounds\\fireorb.mp3", "TTS Flame orb on you", true)
local ttsVortex = mod:NewSoundFile("Interface\\AddOns\\DBM-Core\\sounds\\shockvortex.mp3", "TTS Empowered Vortex cast", false)
