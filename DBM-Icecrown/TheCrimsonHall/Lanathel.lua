...
local ttsBite = mod:NewSoundFile("Interface\\AddOns\\DBM-Core\\sounds\\bitecd.mp3", "TTS Bite countdown", true)
local ttsPact = mod:NewSoundFile("Interface\\AddOns\\DBM-Core\\sounds\\link.mp3", "TTS Pact call", true)
local ttsPing = mod:NewSoundFile("Interface\\AddOns\\DBM-Core\\sounds\\runaway.mp3", "TTS Swarming Shadows", true)
