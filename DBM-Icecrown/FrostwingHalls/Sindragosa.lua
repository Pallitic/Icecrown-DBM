...
local ttsBeacon = mod:NewSoundFile("Interface\\AddOns\\DBM-Core\\sounds\\icc\\sindy\\beaconOnYou.mp3", "TTS Beacon on you", true)
local ttsHighChilledToBone = mod:NewSoundFile("Interface\\AddOns\\DBM-Core\\sounds\\icc\\sindy\\highChilledToBone.mp3", "TTS High Chilled stacks", true)
