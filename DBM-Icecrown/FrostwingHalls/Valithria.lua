...
local ttsSuppressersSpawned = mod:NewSoundFile("Interface\\AddOns\\DBM-Core\\sounds\\suppressersSpawned.mp3", "TTS Supressers Spawned", mod:IsMelee() or mod:IsRanged())
