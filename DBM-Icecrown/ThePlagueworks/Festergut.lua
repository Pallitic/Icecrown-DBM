...
local timerGooCD			= mod:NewNextTimer(13, 72549)

local ttsGasSpore = mod:NewSoundFile("Interface\\AddOns\\DBM-Core\\sounds\\icc\\fester\\gasspore.mp3", "TTS Gas Spore call", true)
local ttsDefensive = mod:NewSoundFile("Interface\\AddOns\\DBM-Core\\sounds\\icc\\fester\\UseDefensive.wav", "TTS Defensives for pungent", true)
