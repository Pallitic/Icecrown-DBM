...
local ttsMalleable = mod:NewSoundFile("Interface\\AddOns\\DBM-Core\\sounds\\malleablecd.mp3", "TTS Malleable Countdown", false)
local ttsGoo = mod:NewSoundFile("Interface\\AddOns\\DBM-Core\\sounds\\malleable.mp3", "TTS Malleable goo Summon", true)
