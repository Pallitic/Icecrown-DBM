...
local ttsChoking = mod:NewSoundFile("Interface\\AddOns\\DBM-Core\\sounds\\gasbomb.mp3", "TTS Choking call", true)
local ttsMalleableGoo = mod:NewSoundFile("Interface\\AddOns\\DBM-Core\\sounds\\malleable.mp3", "TTS Malleable Goo call", true)
local ttsGreenOoze = mod:NewSoundFile("Interface\\AddOns\\DBM-Core\\sounds\\oozevariable.mp3", "TTS Ooze Variable call", true)
local ttsRedOoze = mod:NewSoundFile("Interface\\AddOns\\DBM-Core\\sounds\\gasvariable.mp3", "TTS Gas Variable call", true)
local tts83percent = mod:NewSoundFile("Interface\\AddOns\\DBM-Core\\sounds\\83percent.mp3", "TTS 83percent call", false)
local tts37percent = mod:NewSoundFile("Interface\\AddOns\\DBM-Core\\sounds\\37percent.mp3", "TTS 37percent call", false)
local ttsUnstableExperiment = mod:NewSoundFile("Interface\\AddOns\\DBM-Core\\sounds\\oozecd.mp3", "TTS Ooze Countdown", false)
local ttsGaseousBloat = mod:NewSoundFile("Interface\\AddOns\\DBM-Core\\sounds\\redooze.mp3", "TTS Red ooze on you call", true)
