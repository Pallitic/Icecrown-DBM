...
local ttsSticky = mod:NewSoundFile("Interface\\AddOns\\DBM-Core\\sounds\\icc\\lk\\RunOut.wav", "TTS move out of sticky", true)
local ttsDefensive = mod:NewSoundFile("Interface\\AddOns\\DBM-Core\\sounds\\icc\\fester\\UseDefensive.wav", "TTS Defensives for infection", true)
local ttsExplosion = mod:NewSoundFile("Interface\\AddOns\\DBM-Core\\sounds\\icc\\lk\\RunOut.wav", "TTS ooze explosion", true)
