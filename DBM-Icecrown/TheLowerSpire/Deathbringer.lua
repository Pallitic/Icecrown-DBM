...
local ttsBeastCD = mod:NewSoundFile("Interface\\AddOns\\DBM-Core\\sounds\\beastscd.mp3", "TTS Beasts countdown", false)
...
local ttsBeasts = mod:NewSoundFile("Interface\\AddOns\\DBM-Core\\sounds\\beasts.mp3", "TTS Beasts summon", true)																																											 
