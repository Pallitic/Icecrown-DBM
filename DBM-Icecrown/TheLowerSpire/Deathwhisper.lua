...
local ttsAddsCD = mod:NewSoundFile("Interface\\AddOns\\DBM-Core\\sounds\\addscd.mp3", "TTS Adds Countdown", false)
local ttsDominateMindCD = mod:NewSoundFile("Interface\\AddOns\\DBM-Core\\sounds\\mccd.mp3", "TTS Dominate Mind Countdown", true)
local ttsSpiritsSpawned = mod:NewSoundFile("Interface\\AddOns\\DBM-Core\\sounds\\spirits.mp3", "TTS Spirit spawn callout", true)
local ttsOnYouRun = mod:NewSoundFile("Interface\\AddOns\\DBM-Core\\sounds\\onYouRun.mp3", "TTS Spirit on you callout", false)
local ttsEquipped = mod:NewSoundFile("Interface\\AddOns\\DBM-Core\\sounds\\equipped.mp3", "TTS auto equp callout", false)
local ttsUnequipped = mod:NewSoundFile("Interface\\AddOns\\DBM-Core\\sounds\\unequipped.mp3", "TTS auto unequip callout", false)
