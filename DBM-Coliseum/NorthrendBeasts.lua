...
-- 23 -> 17.5
local timerCombatStart		= mod:NewTimer(23.5, "TimerCombatStart", 2457)
...
local ttsFire = mod:NewSoundFile("Interface\\AddOns\\DBM-Core\\sounds\\icc\\lk\\RunOut.wav", "TTS move out of fire", true)
local ttsSlime = mod:NewSoundFile("Interface\\AddOns\\DBM-Core\\sounds\\icc\\lk\\RunOut.wav", "TTS move out of slime", true)
local ttsCharge = mod:NewSoundFile("Interface\\AddOns\\DBM-Core\\sounds\\icc\\lk\\RunOut.wav", "TTS move out of charge", true)
