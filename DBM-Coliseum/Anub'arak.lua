...
local TTSstun = mod:NewSoundFile("Interface\\AddOns\\DBM-Core\\sounds\\toc\\anub\\stunIn3.mp3", "TTS Stun countdown", true)
local ttsRun = mod:NewSoundFile("Interface\\AddOns\\DBM-Core\\sounds\\icc\\lady\\onYouRun.mp3", "TTS Chasing you", true)
local ttsChill = mod:NewSoundFile("Interface\\AddOns\\DBM-Core\\sounds\\toc\\anub\\chill.mp3", "TTS Dont over heal", mod:IsHealer())
local ttsAdds = mod:NewSoundFile("Interface\\AddOns\\DBM-Core\\sounds\\toc\\anub\\adds.mp3", "TTS Adds spawn", mod:IsTank())
