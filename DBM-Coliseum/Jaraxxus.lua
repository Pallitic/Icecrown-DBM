...
local ttsDispel = mod:NewSoundFile("Interface\\AddOns\\DBM-Core\\sounds\\toc\\jara\\dispel.mp3", "TTS Dispel nether", isDispeller)
local ttsPortal = mod:NewSoundFile("Interface\\AddOns\\DBM-Core\\sounds\\toc\\jara\\portal.mp3", "TTS Portal soon", true)
local ttsFlame = mod:NewSoundFile("Interface\\AddOns\\DBM-Core\\sounds\\icc\\lk\\RunOut.wav", "TTS run out with fire", true)
local ttsVolcano = mod:NewSoundFile("Interface\\AddOns\\DBM-Core\\sounds\\toc\\jara\\volcano.mp3", "TTS Volcano soon", true)
local ttsInterupt = mod:NewSoundFile("Interface\\AddOns\\DBM-Core\\sounds\\icc\\lady\\Interrupt.wav", "TTS interupt", true)
