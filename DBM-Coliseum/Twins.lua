...
local ttsColor = mod:NewSoundFile("Interface\\AddOns\\DBM-Core\\sounds\\toc\\valks\\color.mp3", "TTS Change color", true)
local ttsChange = mod:NewSoundFile("Interface\\AddOns\\DBM-Core\\sounds\\toc\\valks\\target.mp3", "TTS Change target", true)
