...
local ttsDecimate = mod:NewSoundFile("Interface\\AddOns\\DBM-Core\\sounds\\naxx\\decimate.mp3", "TTS Decimate soon", true)
...
function mod:OnCombatStart(delay)
	...
	ttsDecimate:Schedule(100 - delay)
end
