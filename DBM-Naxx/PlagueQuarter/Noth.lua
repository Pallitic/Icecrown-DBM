...
local ttsAggro = mod:NewSoundFile("Interface\\AddOns\\DBM-Core\\sounds\\naxx\\aggro.mp3", "TTS Watch aggro after blink", true)
local ttsCurse = mod:NewSoundFile("Interface\\AddOns\\DBM-Core\\sounds\\naxx\\curse.mp3", "TTS Dispel the curse", true)
