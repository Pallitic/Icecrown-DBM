...
local ttsStorm = mod:NewSoundFile("Interface\\AddOns\\DBM-Core\\sounds\\uld\\hodir\\storm.mp3", "TTS Storm Power", true)
local ttsStacks = mod:NewSoundFile("Interface\\AddOns\\DBM-Core\\sounds\\uld\\hodir\\stacks.mp3", "TTS High frost stacks", true)
local ttsFlash = mod:NewSoundFile("Interface\\AddOns\\DBM-Core\\sounds\\uld\\hodir\\flash.mp3", "TTS Flash freeze", true)
local ttsBlow = mod:NewSoundFile("Interface\\AddOns\\DBM-Core\\sounds\\uld\\hodir\\blows.mp3", "TTS Frozen blows", mod:IsTank())
