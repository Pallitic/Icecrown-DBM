...
local ttsVoid = mod:NewSoundFile("Interface\\AddOns\\DBM-Core\\sounds\\icc\\lk\\RunOut.wav", "TTS void move out", true)
local ttsInterupt = mod:NewSoundFile("Interface\\AddOns\\DBM-Core\\sounds\\icc\\lady\\Interrupt.wav", "TTS interupt", canInterrupt)
