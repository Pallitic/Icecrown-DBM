...
local ttsAdds = mod:NewSoundFile("Interface\\AddOns\\DBM-Core\\sounds\\uld\\kolo\\adds.mp3", "TTS Adds spawn", true)
local ttsGrip = mod:NewSoundFile("Interface\\AddOns\\DBM-Core\\sounds\\uld\\kolo\\grip.mp3", "TTS Players gripped", true)
local ttsNear = mod:NewSoundFile("Interface\\AddOns\\DBM-Core\\sounds\\uld\\kolo\\beamnear.mp3", "TTS Beam near", true)
local ttsBeam = mod:NewSoundFile("Interface\\AddOns\\DBM-Core\\sounds\\uld\\kolo\\beamu.mp3", "TTS Beam on you", true)
