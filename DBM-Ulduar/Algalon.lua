...
local ttsCosmic = mod:NewSoundFile("Interface\\AddOns\\DBM-Core\\sounds\\uld\\alg\\cosmic.mp3", "TTS Cosmic Smash", true)
local ttsBigbang = mod:NewSoundFile("Interface\\AddOns\\DBM-Core\\sounds\\uld\\alg\\bigbang.mp3", "TTS Big bang", true)
