...
local ttsTremor = mod:NewSoundFile("Interface\\AddOns\\DBM-Core\\sounds\\uld\\freya\\tremor.mp3", "TTS Ground tremor", true)
local ttsBeam = mod:NewSoundFile("Interface\\AddOns\\DBM-Core\\sounds\\icc\\lk\\RunOut.wav", "TTS Beams, run out", true)
local ttsGift = mod:NewSoundFile("Interface\\AddOns\\DBM-Core\\sounds\\uld\\freya\\gift.mp3", "TTS Gift soon", true)
