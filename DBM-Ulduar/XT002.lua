...
local ttsGravity = mod:NewSoundFile("Interface\\AddOns\\DBM-Core\\sounds\\icc\\lk\\RunOut.wav", "TTS Gravity bomb", true)
local ttsLight = mod:NewSoundFile("Interface\\AddOns\\DBM-Core\\sounds\\icc\\lk\\RunOut.wav", "TTS Light bomb", true)
local ttsDefensive = mod:NewSoundFile("Interface\\AddOns\\DBM-Core\\sounds\\icc\\fester\\UseDefensive.wav", "TTS Defensives for Tantrum", true)
