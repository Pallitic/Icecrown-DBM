...
local ttsPhase = mod:NewSoundFile("Interface\\AddOns\\DBM-Core\\sounds\\uld\\thor\\phase.mp3", "TTS Phase 2", true)
local ttsVolley = mod:NewSoundFile("Interface\\AddOns\\DBM-Core\\sounds\\uld\\thor\\fbv.mp3", "TTS Frostbolt volley soon", true)
