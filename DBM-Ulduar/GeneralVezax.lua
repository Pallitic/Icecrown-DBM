...
local ttsCrash = mod:NewSoundFile("Interface\\AddOns\\DBM-Core\\sounds\\uld\\vez\\crash.mp3", "TTS Shadow crash", true)
local ttsLeech = mod:NewSoundFile("Interface\\AddOns\\DBM-Core\\sounds\\icc\\lk\\RunOut.wav", "TTS Mark run out", true)
local ttsSurge = mod:NewSoundFile("Interface\\AddOns\\DBM-Core\\sounds\\uld\\vez\\surge.mp3", "TTS Surge of darkness", mod:IsTank())
