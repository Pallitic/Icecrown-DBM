...
local ttsOut = mod:NewSoundFile("Interface\\AddOns\\DBM-Core\\sounds\\uld\\yogg\\out.mp3", "TTS Move out of brain", true)
local ttsFervor = mod:NewSoundFile("Interface\\AddOns\\DBM-Core\\sounds\\uld\\yogg\\fervor.mp3", "TTS Fervor on you", true)
local ttsDeafen = mod:NewSoundFile("Interface\\AddOns\\DBM-Core\\sounds\\uld\\yogg\\deafen.mp3", "TTS Deafening roar soon", true)
local ttsSanity = mod:NewSoundFile("Interface\\AddOns\\DBM-Core\\sounds\\uld\\yogg\\sanity.mp3", "TTS Sanity warning", true)
local ttsDying = mod:NewSoundFile("Interface\\AddOns\\DBM-Core\\sounds\\uld\\yogg\\dying.mp3", "TTS Guardian dying p1", mod:IsMelee())
local ttsLink = mod:NewSoundFile("Interface\\AddOns\\DBM-Core\\sounds\\uld\\yogg\\blink.mp3", "TTS Brain link", true)
local ttsPortal = mod:NewSoundFile("Interface\\AddOns\\DBM-Core\\sounds\\uld\\yogg\\portal.mp3", "TTS Portals soon", true)
local ttsMalady = mod:NewSoundFile("Interface\\AddOns\\DBM-Core\\sounds\\uld\\yogg\\malady.mp3", "TTS Malady Near", true)
